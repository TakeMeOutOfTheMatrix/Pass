...
//алгоритм SHA-256
    ...
    public static String bruteForce(int size) throws NoSuchAlgorithmException {
        ...
        //Введите здесь искомый пароль:
        String pass = "1115dd800feaacefdf481f1f9070374a2a81e27880f187396db67958b207cbad";
        return computePermutations(size, password, 0, pass);
    }

    private static String computePermutations(int size, int[] password, int position, String pass) throws NoSuchAlgorithmException
    {
        String testString = "";
        String par = "";
        for (int i = 0; i < 26; i++)
            ...
            } else if (position == size - 1)
            {
               ...
               try(FileWriter writer = new FileWriter("passwords.txt", true))
                ...
                catch(IOException ex)
                {
                    ...
                    if (toHexString(getSHA(par)).equalsIgnoreCase(pass))
                    {
